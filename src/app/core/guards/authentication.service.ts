...
export class AuthenticationService {
  ...
  login = (username: string, password: string, hasRemember: boolean) =>
    this.http
      .post<any>(`${environment.domain}/api/Authencation/login`, {
        username: username,
        password: password,
      })
      .subscribe(
  ...
  register = (
    ...
    this.http
      .post<any>(`${environment.domain}/api/Authencation/register`, {
        email: email,
        password: password,
